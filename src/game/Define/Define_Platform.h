...
#define FACEBOOK_URL    "http://www.facebook.com/PineEntertainment/"
#define TWITTER_URL     "http://www.twitter.com/PineGames"
...
#define FACEBOOK_PERMISSION [@"user_friends",@"user_games_activity"]
#define FACEBOOK_PERMISSION_FOR_STREAM [@"user_friends",@"publish_actions", @"user_games_activity"]
#define FACEBOOK_APP_LINK "https://fb.me/1430913180547779"
...
#define UNITY_ADS_ID_DEFAULT "108705"
#define ADMOB_INTERSTITIAL_ID "ca-app-pub-6305464951596521/6672955895"
...
#define ADMOB_ID2_DEFAULT "6672955895"

#define ADD_VUNGLEADS   1
#define ADD_PINE_ADVERT 1
#define VUNGLE_ID_DEFAULT   "56fb5509c5375ae10600000f"
...
#define PROCESSING_DIALOG_YESNO(context,index) {((FDGame*)CGame::_this->_current_game)->ProcessingDialogYesNo(context,index);}
#define PROCESSING_DIALOG_OK(context)	{((FDGame*)CGame::_this->_current_game)->ProcessingDialogOK(context);}

#define COMPLETE_SEND_REQUET()  {CGame::_this->CompleteSendRequest();}
