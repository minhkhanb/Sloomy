...
import pine.core.UpdateCloudSaveResultCode;
		...
		implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener
{
	...
	static public boolean isUserCancelLogin()
	{
		...
		try
		{
			...
			FileInputStream f = new FileInputStream(dataPath + "/" + "loginGPGS.p");
			if (f != null) {
				...
				if (fIn != null) {
					...
					Log.i("DEBUG", "cannot read from: " + dataPath + "loginGPGS.p");
				}
				f.close();
			}else {
				Log.i("DEBUG", "cannot read from: " + dataPath + "loginGPGS.p");
	...
	static public void setUserCancelLogin(boolean userChoose)
	{
		...
		{
			String dataPath = "data/data/" + GetDataPath();
			FileOutputStream f = new FileOutputStream(dataPath + "/" + "loginGPGS.p", false);
			if (f != null) {
				...
				if (fOut != null) {
					...
					Log.i("DEBUG", "cannot write to : " + dataPath + "loginGPGS.p");
				}
				f.close();
			}
			else {
